...
var routes = [
    ...
    { path: 'turma', loadChildren: './turma/turma.module#TurmaPageModule', canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_0__["AuthGuard"]] }
];
...
module.exports = __webpack_require__(/*! /Applications/MAMP/htdocs/unidavi-router/src/main.ts */"./src/main.ts");
